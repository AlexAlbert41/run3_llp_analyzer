...
void usage()
{
  std::cerr << "Usage: Runllp_MuonSystem_CA_TnP_noClusters_VetoEff_mdsnano  <input list>  [options]\n[options]:\n"
	    << "-d  --isData\n"
...
int main(int argc, char* argv[]){
  ...
  std::cout << "[INFO]: optionalLabel --> " << label << std::endl;
    ...
    llp_MuonSystem_CA_TnP_noClusters_VetoEff_mdsnano analyzer(theChain);

    //------ EXECUTE ------//
    cout << "Executing llp_MuonSystem_CA_TnP_noClusters_VetoEff_mdsnano..." << endl;
    analyzer.EnableAll();
