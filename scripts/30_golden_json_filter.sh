...
function write_loader {
    ...
    JSON_PATH=$(/uscms/home/amalbert/nobackup/CMSSW_10_6_20/src/run3_llp_analyzer/golden_jsons/Cert_Collisions2022_355100_362760_Golden.json  $1)
...
function get_json_path {
    ...
    INP_FILE=$(/uscms/home/amalbert/nobackup/CMSSW_10_6_20/src/run3_llp_analyzer/golden_jsons/Cert_Collisions2022_355100_362760_Golden.json  $1)
...
ls $DATA_PATH/*.root | parallel --progress -j $N_JOBS filter {}
