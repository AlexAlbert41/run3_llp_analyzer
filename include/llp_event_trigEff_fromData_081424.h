...
// Wed Aug 14 17:20:23 2024 by ROOT version 6.14/09
// from TTree Events/Events
// found on file: /eos/uscms/store/group/lpclonglived/MergedNtuples_Run3/merged/merged_Run2022E.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nCorrT1METJet;
   Float_t         CorrT1METJet_area[49];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_eta[49];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_muonSubtrFactor[49];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_phi[49];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_rawPt[49];   //[nCorrT1METJet]
   ...
   Int_t           nJet;
   UChar_t         Jet_jetId[75];   //[nJet]
   UChar_t         Jet_nConstituents[75];   //[nJet]
   UChar_t         Jet_nElectrons[75];   //[nJet]
   UChar_t         Jet_nMuons[75];   //[nJet]
   UChar_t         Jet_nSVs[75];   //[nJet]
   Short_t         Jet_electronIdx1[75];   //[nJet]
   Short_t         Jet_electronIdx2[75];   //[nJet]
   Short_t         Jet_muonIdx1[75];   //[nJet]
   Short_t         Jet_muonIdx2[75];   //[nJet]
   Short_t         Jet_svIdx1[75];   //[nJet]
   Short_t         Jet_svIdx2[75];   //[nJet]
   Int_t           Jet_hfadjacentEtaStripsSize[75];   //[nJet]
   Int_t           Jet_hfcentralEtaStripSize[75];   //[nJet]
   Float_t         Jet_PNetRegPtRawCorr[75];   //[nJet]
   Float_t         Jet_PNetRegPtRawCorrNeutrino[75];   //[nJet]
   Float_t         Jet_PNetRegPtRawRes[75];   //[nJet]
   Float_t         Jet_area[75];   //[nJet]
   Float_t         Jet_btagDeepFlavB[75];   //[nJet]
   Float_t         Jet_btagDeepFlavCvB[75];   //[nJet]
   Float_t         Jet_btagDeepFlavCvL[75];   //[nJet]
   Float_t         Jet_btagDeepFlavQG[75];   //[nJet]
   Float_t         Jet_btagPNetB[75];   //[nJet]
   Float_t         Jet_btagPNetCvB[75];   //[nJet]
   Float_t         Jet_btagPNetCvL[75];   //[nJet]
   Float_t         Jet_btagPNetQvG[75];   //[nJet]
   Float_t         Jet_btagPNetTauVJet[75];   //[nJet]
   Float_t         Jet_btagRobustParTAK4B[75];   //[nJet]
   Float_t         Jet_btagRobustParTAK4CvB[75];   //[nJet]
   Float_t         Jet_btagRobustParTAK4CvL[75];   //[nJet]
   Float_t         Jet_btagRobustParTAK4QG[75];   //[nJet]
   Float_t         Jet_chEmEF[75];   //[nJet]
   Float_t         Jet_chHEF[75];   //[nJet]
   Float_t         Jet_eta[75];   //[nJet]
   Float_t         Jet_hfsigmaEtaEta[75];   //[nJet]
   Float_t         Jet_hfsigmaPhiPhi[75];   //[nJet]
   Float_t         Jet_mass[75];   //[nJet]
   Float_t         Jet_muEF[75];   //[nJet]
   Float_t         Jet_muonSubtrFactor[75];   //[nJet]
   Float_t         Jet_neEmEF[75];   //[nJet]
   Float_t         Jet_neHEF[75];   //[nJet]
   Float_t         Jet_phi[75];   //[nJet]
   Float_t         Jet_pt[75];   //[nJet]
   Float_t         Jet_rawFactor[75];   //[nJet]
   Int_t           nLowPtElectron;
   Bool_t          LowPtElectron_convVeto[12];   //[nLowPtElectron]
   UChar_t         LowPtElectron_convWP[12];   //[nLowPtElectron]
   UChar_t         LowPtElectron_lostHits[12];   //[nLowPtElectron]
   Short_t         LowPtElectron_electronIdx[12];   //[nLowPtElectron]
   Short_t         LowPtElectron_photonIdx[12];   //[nLowPtElectron]
   Int_t           LowPtElectron_charge[12];   //[nLowPtElectron]
   Int_t           LowPtElectron_pdgId[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_ID[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_convVtxRadius[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_deltaEtaSC[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_dxy[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_dxyErr[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_dz[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_dzErr[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_eInvMinusPInv[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_energyErr[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_eta[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_hoe[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_mass[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_miniPFRelIso_all[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_miniPFRelIso_chg[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_phi[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_pt[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_ptbiased[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_r9[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_scEtOverPt[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_sieie[12];   //[nLowPtElectron]
   Float_t         LowPtElectron_unbiased[12];   //[nLowPtElectron]
   ...
   Int_t           nMuon;
   UChar_t         Muon_highPtId[54];   //[nMuon]
   Bool_t          Muon_highPurity[54];   //[nMuon]
   Bool_t          Muon_inTimeMuon[54];   //[nMuon]
   Bool_t          Muon_isGlobal[54];   //[nMuon]
   Bool_t          Muon_isPFcand[54];   //[nMuon]
   Bool_t          Muon_isStandalone[54];   //[nMuon]
   Bool_t          Muon_isTracker[54];   //[nMuon]
   UChar_t         Muon_jetNDauCharged[54];   //[nMuon]
   Bool_t          Muon_looseId[54];   //[nMuon]
   Bool_t          Muon_mediumId[54];   //[nMuon]
   Bool_t          Muon_mediumPromptId[54];   //[nMuon]
   UChar_t         Muon_miniIsoId[54];   //[nMuon]
   UChar_t         Muon_multiIsoId[54];   //[nMuon]
   UChar_t         Muon_mvaMuID_WP[54];   //[nMuon]
   UChar_t         Muon_nStations[54];   //[nMuon]
   UChar_t         Muon_nTrackerLayers[54];   //[nMuon]
   UChar_t         Muon_pfIsoId[54];   //[nMuon]
   UChar_t         Muon_puppiIsoId[54];   //[nMuon]
   Bool_t          Muon_softId[54];   //[nMuon]
   Bool_t          Muon_softMvaId[54];   //[nMuon]
   UChar_t         Muon_tightCharge[54];   //[nMuon]
   Bool_t          Muon_tightId[54];   //[nMuon]
   UChar_t         Muon_tkIsoId[54];   //[nMuon]
   Bool_t          Muon_triggerIdLoose[54];   //[nMuon]
   Short_t         Muon_jetIdx[54];   //[nMuon]
   Short_t         Muon_svIdx[54];   //[nMuon]
   Short_t         Muon_fsrPhotonIdx[54];   //[nMuon]
   Int_t           Muon_charge[54];   //[nMuon]
   Int_t           Muon_pdgId[54];   //[nMuon]
   Float_t         Muon_dxy[54];   //[nMuon]
   Float_t         Muon_dxyErr[54];   //[nMuon]
   Float_t         Muon_dxybs[54];   //[nMuon]
   Float_t         Muon_dz[54];   //[nMuon]
   Float_t         Muon_dzErr[54];   //[nMuon]
   Float_t         Muon_eta[54];   //[nMuon]
   Float_t         Muon_ip3d[54];   //[nMuon]
   Float_t         Muon_jetPtRelv2[54];   //[nMuon]
   Float_t         Muon_jetRelIso[54];   //[nMuon]
   Float_t         Muon_mass[54];   //[nMuon]
   Float_t         Muon_miniPFRelIso_all[54];   //[nMuon]
   Float_t         Muon_miniPFRelIso_chg[54];   //[nMuon]
   Float_t         Muon_mvaMuID[54];   //[nMuon]
   Float_t         Muon_pfRelIso03_all[54];   //[nMuon]
   Float_t         Muon_pfRelIso03_chg[54];   //[nMuon]
   Float_t         Muon_pfRelIso04_all[54];   //[nMuon]
   Float_t         Muon_phi[54];   //[nMuon]
   Float_t         Muon_pt[54];   //[nMuon]
   Float_t         Muon_ptErr[54];   //[nMuon]
   Float_t         Muon_segmentComp[54];   //[nMuon]
   Float_t         Muon_sip3d[54];   //[nMuon]
   Float_t         Muon_softMva[54];   //[nMuon]
   Float_t         Muon_tkRelIso[54];   //[nMuon]
   Float_t         Muon_tunepRelPt[54];   //[nMuon]
   Float_t         Muon_bsConstrainedChi2[54];   //[nMuon]
   Float_t         Muon_bsConstrainedPt[54];   //[nMuon]
   Float_t         Muon_bsConstrainedPtErr[54];   //[nMuon]
   Float_t         Muon_mvaLowPt[54];   //[nMuon]
   Float_t         Muon_mvaTTH[54];   //[nMuon]
   Int_t           nPhoton;
   ...
   Float_t         Tau_rawPNetVSmu[10];   //[nTau]
   Float_t         TkMET_phi;
   Float_t         TkMET_pt;
   Float_t         TkMET_sumEt;
   Int_t           nTrigObj;
   Short_t         TrigObj_l1charge[96];   //[nTrigObj]
   UShort_t        TrigObj_id[96];   //[nTrigObj]
   Int_t           TrigObj_l1iso[96];   //[nTrigObj]
   Int_t           TrigObj_filterBits[96];   //[nTrigObj]
   Float_t         TrigObj_pt[96];   //[nTrigObj]
   Float_t         TrigObj_eta[96];   //[nTrigObj]
   Float_t         TrigObj_phi[96];   //[nTrigObj]
   Float_t         TrigObj_l1pt[96];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[96];   //[nTrigObj]
   Float_t         TrigObj_l2pt[96];   //[nTrigObj]
   Int_t           nOtherPV;
   ...
   Float_t         PV_score;
   Int_t           nSV;
   Short_t         SV_charge[22];   //[nSV]
   Float_t         SV_dlen[22];   //[nSV]
   Float_t         SV_dlenSig[22];   //[nSV]
   Float_t         SV_dxy[22];   //[nSV]
   Float_t         SV_dxySig[22];   //[nSV]
   Float_t         SV_pAngle[22];   //[nSV]
   UChar_t         SV_ntracks[22];   //[nSV]
   Float_t         SV_chi2[22];   //[nSV]
   Float_t         SV_eta[22];   //[nSV]
   Float_t         SV_mass[22];   //[nSV]
   Float_t         SV_ndof[22];   //[nSV]
   Float_t         SV_phi[22];   //[nSV]
   Float_t         SV_pt[22];   //[nSV]
   Float_t         SV_x[22];   //[nSV]
   Float_t         SV_y[22];   //[nSV]
   Float_t         SV_z[22];   //[nSV]
   ...
   Int_t           nDtRechits;
   Int_t           nRpc;
   Float_t         cscRechitsPhi[19845];   //[nCscRechits]
   Float_t         cscRechitsEta[19845];   //[nCscRechits]
   Float_t         cscRechitsX[19845];   //[nCscRechits]
   Float_t         cscRechitsY[19845];   //[nCscRechits]
   Float_t         cscRechitsZ[19845];   //[nCscRechits]
   Float_t         cscRechitsTpeak[19845];   //[nCscRechits]
   Float_t         cscRechitsTwire[19845];   //[nCscRechits]
   Float_t         dtRechitCorrectX[13223];   //[nDtRechits]
   Float_t         dtRechitCorrectY[13223];   //[nDtRechits]
   Float_t         dtRechitCorrectZ[13223];   //[nDtRechits]
   Float_t         dtRechitCorrectEta[13223];   //[nDtRechits]
   Float_t         dtRechitCorrectPhi[13223];   //[nDtRechits]
   Float_t         cscSegPhi[425];   //[nCscSeg]
   Float_t         cscSegEta[425];   //[nCscSeg]
   Float_t         dtSegPhi[1443];   //[nDtSeg]
   Float_t         dtSegEta[1443];   //[nDtSeg]
   Float_t         rpcPhi[1449];   //[nRpc]
   Float_t         rpcEta[1449];   //[nRpc]
   Float_t         rpcX[1449];   //[nRpc]
   Float_t         rpcY[1449];   //[nRpc]
   Float_t         rpcZ[1449];   //[nRpc]
   Float_t         rpcT[1449];   //[nRpc]
   Float_t         rpcTError[1449];   //[nRpc]
   Int_t           cscRechitsChamber[19845];   //[nCscRechits]
   Int_t           cscRechitsStation[19845];   //[nCscRechits]
   Int_t           cscRechitsDetId[19845];   //[nCscRechits]
   Int_t           dtRechitStation[13223];   //[nDtRechits]
   Int_t           dtRechitWheel[13223];   //[nDtRechits]
   Int_t           dtRechitSuperLayer[13223];   //[nDtRechits]
   Int_t           cscSegChamber[425];   //[nCscSeg]
   Int_t           cscSegStation[425];   //[nCscSeg]
   Int_t           cscSegNRecHits[425];   //[nCscSeg]
   Int_t           dtSegStation[1443];   //[nDtSeg]
   Int_t           dtSegWheel[1443];   //[nDtSeg]
   Int_t           rpcBx[1449];   //[nRpc]
   Int_t           rpcRegion[1449];   //[nRpc]
   Int_t           rpcRing[1449];   //[nRpc]
   Int_t           rpcSector[1449];   //[nRpc]
   Int_t           rpcStation[1449];   //[nRpc]
   Int_t           rpcLayer[1449];   //[nRpc]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms/store/group/lpclonglived/MergedNtuples_Run3/merged/merged_Run2022E.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/uscms/store/group/lpclonglived/MergedNtuples_Run3/merged/merged_Run2022E.root");
      }
