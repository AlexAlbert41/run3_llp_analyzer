...
// Wed May  8 16:37:10 2024 by ROOT version 6.14/09
// from TTree llp/selected AOD information for llp analyses
// found on file: root://cmsxrootd.fnal.gov//store/user/zhao1/llp/merge_dymc/merge_displacedJetMuon_ntupler_dymc.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nPVAll;
   Float_t         pvAllX[104];   //[nPVAll]
   Float_t         pvAllY[104];   //[nPVAll]
   Float_t         pvAllZ[104];   //[nPVAll]
   Float_t         pvAllLogSumPtSq[104];   //[nPVAll]
   Float_t         pvAllSumPx[104];   //[nPVAll]
   Float_t         pvAllSumPy[104];   //[nPVAll]
   Int_t           nBunchXing;
   ...
   Int_t           nCscSeg;
   Float_t         cscSegPhi[107];   //[nCscSeg]
   Float_t         cscSegEta[107];   //[nCscSeg]
   Float_t         cscSegX[107];   //[nCscSeg]
   Float_t         cscSegY[107];   //[nCscSeg]
   Float_t         cscSegZ[107];   //[nCscSeg]
   Float_t         cscSegT[107];   //[nCscSeg]
   Float_t         cscSegChi2[107];   //[nCscSeg]
   Int_t           cscSegChamber[107];   //[nCscSeg]
   Int_t           cscSegStation[107];   //[nCscSeg]
   Int_t           cscSegNRecHits[107];   //[nCscSeg]
   Int_t           ncscRechits;
   Float_t         cscRechitsPhi[2463];   //[ncscRechits]
   Float_t         cscRechitsEta[2463];   //[ncscRechits]
   Float_t         cscRechitsX[2463];   //[ncscRechits]
   Float_t         cscRechitsY[2463];   //[ncscRechits]
   Float_t         cscRechitsZ[2463];   //[ncscRechits]
   Float_t         cscRechitsE[2463];   //[ncscRechits]
   Float_t         cscRechitsTpeak[2463];   //[ncscRechits]
   Float_t         cscRechitsTwire[2463];   //[ncscRechits]
   Int_t           cscRechitsQuality[2463];   //[ncscRechits]
   Int_t           cscRechitsChamber[2463];   //[ncscRechits]
   Int_t           cscRechitsStation[2463];   //[ncscRechits]
   Int_t           cscRechitsClusterId[2463];   //[ncscRechits]
   Int_t           cscRechitsChannels[2463];   //[ncscRechits]
   UInt_t          cscRechitsNStrips[2463];   //[ncscRechits]
   Int_t           cscRechitsHitWire[2463];   //[ncscRechits]
   Int_t           cscRechitsWGroupsBX[2463];   //[ncscRechits]
   UInt_t          cscRechitsNWireGroups[2463];   //[ncscRechits]
   Int_t           cscRechitsDetId[2463];   //[ncscRechits]
   Int_t           nCscRechitClusters;
   Float_t         cscRechitCluster_match_cscSegCluster_minDeltaR[4];   //[nCscRechitClusters]
   Int_t           cscRechitCluster_match_cscSegCluster_index[4];   //[nCscRechitClusters]
   Float_t         cscRechitCluster_match_gParticle_minDeltaR[4];   //[nCscRechitClusters]
   Int_t           cscRechitCluster_match_gParticle_index[4];   //[nCscRechitClusters]
   Int_t           cscRechitCluster_match_gParticle_id[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterX[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterY[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterZ[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTime[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTimeTotal[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTimeWeighted[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTimeSpreadWeighted[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTimeSpreadWeightedAll[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTimeSpread[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterGenMuonDeltaR[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMajorAxis[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMinorAxis[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterEtaPhiSpread[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterPhiSpread[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterEtaSpread[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterXSpread[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterXYSpread[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterRSpread[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterYSpread[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterZSpread[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterPhi[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterEta[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterJetVetoPt[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterJetVetoE[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMuonVetoPt[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMuonVetoE[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterCaloJetVeto[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterSize[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus11[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus12[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus13[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus21[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus22[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus31[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus32[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus41[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus42[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus11[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus12[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus13[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus21[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus22[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus31[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus32[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus41[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus42[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMe11Ratio[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMe12Ratio[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNStation[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterMaxStation[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMaxStationRatio[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNChamber[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterMaxChamber[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMaxChamberRatio[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterVertexR[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterVertexZ[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterVertexDis[4];   //[nCscRechitClusters]
   Float_t         cscRechitClusterVertexChi2[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterVertexN1[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterVertexN5[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterVertexN10[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterVertexN15[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterVertexN20[4];   //[nCscRechitClusters]
   Int_t           cscRechitClusterVertexN[4];   //[nCscRechitClusters]
   Int_t           nCscSegClusters;
   Float_t         cscSegCluster_match_gParticle_minDeltaR[4];   //[nCscSegClusters]
   Int_t           cscSegCluster_match_gParticle_index[4];   //[nCscSegClusters]
   Int_t           cscSegCluster_match_gParticle_id[4];   //[nCscSegClusters]
   Float_t         cscSegClusterX[4];   //[nCscSegClusters]
   Float_t         cscSegClusterY[4];   //[nCscSegClusters]
   Float_t         cscSegClusterZ[4];   //[nCscSegClusters]
   Float_t         cscSegClusterTime[4];   //[nCscSegClusters]
   Float_t         cscSegClusterTimeSpread[4];   //[nCscSegClusters]
   Float_t         cscSegClusterGenMuonDeltaR[4];   //[nCscSegClusters]
   Float_t         cscSegClusterMajorAxis[4];   //[nCscSegClusters]
   Float_t         cscSegClusterMinorAxis[4];   //[nCscSegClusters]
   Float_t         cscSegClusterEtaPhiSpread[4];   //[nCscSegClusters]
   Float_t         cscSegClusterPhiSpread[4];   //[nCscSegClusters]
   Float_t         cscSegClusterEtaSpread[4];   //[nCscSegClusters]
   Float_t         cscSegClusterXSpread[4];   //[nCscSegClusters]
   Float_t         cscSegClusterYSpread[4];   //[nCscSegClusters]
   Float_t         cscSegClusterZSpread[4];   //[nCscSegClusters]
   Float_t         cscSegClusterPhi[4];   //[nCscSegClusters]
   Float_t         cscSegClusterEta[4];   //[nCscSegClusters]
   Float_t         cscSegClusterJetVetoPt[4];   //[nCscSegClusters]
   Float_t         cscSegClusterJetVetoE[4];   //[nCscSegClusters]
   Float_t         cscSegClusterMuonVetoPt[4];   //[nCscSegClusters]
   Float_t         cscSegClusterMuonVetoE[4];   //[nCscSegClusters]
   Float_t         cscSegClusterCaloJetVeto[4];   //[nCscSegClusters]
   Int_t           cscSegClusterSize[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberPlus11[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberPlus12[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberPlus13[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberPlus21[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberPlus22[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberPlus31[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberPlus32[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberPlus41[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberPlus42[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberMinus11[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberMinus12[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberMinus13[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberMinus21[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberMinus22[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberMinus31[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberMinus32[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberMinus41[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNSegmentChamberMinus42[4];   //[nCscSegClusters]
   Float_t         cscSegClusterMe11Ratio[4];   //[nCscSegClusters]
   Float_t         cscSegClusterMe12Ratio[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNStation[4];   //[nCscSegClusters]
   Int_t           cscSegClusterMaxStation[4];   //[nCscSegClusters]
   Float_t         cscSegClusterMaxStationRatio[4];   //[nCscSegClusters]
   Int_t           cscSegClusterNChamber[4];   //[nCscSegClusters]
   Int_t           cscSegClusterMaxChamber[4];   //[nCscSegClusters]
   Float_t         cscSegClusterMaxChamberRatio[4];   //[nCscSegClusters]
   Float_t         cscSegClusterVertexR[4];   //[nCscSegClusters]
   Float_t         cscSegClusterVertexZ[4];   //[nCscSegClusters]
   Float_t         cscSegClusterVertexDis[4];   //[nCscSegClusters]
   Float_t         cscSegClusterVertexChi2[4];   //[nCscSegClusters]
   Int_t           cscSegClusterVertexN1[4];   //[nCscSegClusters]
   Int_t           cscSegClusterVertexN5[4];   //[nCscSegClusters]
   Int_t           cscSegClusterVertexN10[4];   //[nCscSegClusters]
   Int_t           cscSegClusterVertexN15[4];   //[nCscSegClusters]
   Int_t           cscSegClusterVertexN20[4];   //[nCscSegClusters]
   Int_t           cscSegClusterVertexN[4];   //[nCscSegClusters]
   Int_t           nDtRechits;
   Float_t         dtRechitCorrectX[767];   //[nDtRechits]
   Float_t         dtRechitCorrectY[767];   //[nDtRechits]
   Float_t         dtRechitCorrectZ[767];   //[nDtRechits]
   Float_t         dtRechitCorrectEta[767];   //[nDtRechits]
   Float_t         dtRechitCorrectPhi[767];   //[nDtRechits]
   Float_t         dtRechitTime[767];   //[nDtRechits]
   Int_t           dtRechitStation[767];   //[nDtRechits]
   Int_t           dtRechitWheel[767];   //[nDtRechits]
   Int_t           dtRechitSector[767];   //[nDtRechits]
   Int_t           dtRechitLayer[767];   //[nDtRechits]
   Int_t           dtRechitSuperLayer[767];   //[nDtRechits]
   ...
   Int_t           nRpc;
   Float_t         rpcPhi[42];   //[nRpc]
   Float_t         rpcEta[42];   //[nRpc]
   Float_t         rpcX[42];   //[nRpc]
   Float_t         rpcY[42];   //[nRpc]
   Float_t         rpcZ[42];   //[nRpc]
   Float_t         rpcT[42];   //[nRpc]
   Int_t           rpcBx[42];   //[nRpc]
   Float_t         rpcTError[42];   //[nRpc]
   Int_t           rpcRegion[42];   //[nRpc]
   Int_t           rpcRing[42];   //[nRpc]
   Int_t           rpcSector[42];   //[nRpc]
   Int_t           rpcStation[42];   //[nRpc]
   Int_t           rpcLayer[42];   //[nRpc]
   Int_t           nDtSeg;
   Float_t         dtSegPhi[154];   //[nDtSeg]
   Float_t         dtSegEta[154];   //[nDtSeg]
   Float_t         dtSegX[154];   //[nDtSeg]
   Float_t         dtSegY[154];   //[nDtSeg]
   Float_t         dtSegZ[154];   //[nDtSeg]
   Int_t           dtSegStation[154];   //[nDtSeg]
   Int_t           dtSegWheel[154];   //[nDtSeg]
   Float_t         dtSegTime[154];   //[nDtSeg]
   Float_t         dtSegTimeError[154];   //[nDtSeg]
   ...
   Int_t           nJets;
   Float_t         jetE[115];   //[nJets]
   Float_t         jetPt[115];   //[nJets]
   Float_t         jetEta[115];   //[nJets]
   Float_t         jetPhi[115];   //[nJets]
   Float_t         jetCSV[115];   //[nJets]
   Float_t         jetCISV[115];   //[nJets]
   Float_t         jetCMVA[115];   //[nJets]
   Float_t         jetProbb[115];   //[nJets]
   Float_t         jetProbc[115];   //[nJets]
   Float_t         jetProbudsg[115];   //[nJets]
   Float_t         jetProbbb[115];   //[nJets]
   Float_t         jetMass[115];   //[nJets]
   Float_t         jetJetArea[115];   //[nJets]
   Float_t         jetPileupE[115];   //[nJets]
   Float_t         jetPileupId[115];   //[nJets]
   Int_t           jetPileupIdFlag[115];   //[nJets]
   Bool_t          jetPassIDLoose[115];   //[nJets]
   Bool_t          jetPassIDTight[115];   //[nJets]
   Bool_t          jetPassMuFrac[115];   //[nJets]
   Bool_t          jetPassEleFrac[115];   //[nJets]
   Int_t           jetPartonFlavor[115];   //[nJets]
   Int_t           jetHadronFlavor[115];   //[nJets]
   Float_t         jetElectronEnergyFraction[115];   //[nJets]
   Float_t         jetPhotonEnergyFraction[115];   //[nJets]
   Float_t         jetChargedHadronEnergyFraction[115];   //[nJets]
   Float_t         jetNeutralHadronEnergyFraction[115];   //[nJets]
   Float_t         jetMuonEnergyFraction[115];   //[nJets]
   Float_t         jetHOEnergyFraction[115];   //[nJets]
   Float_t         jetHFHadronEnergyFraction[115];   //[nJets]
   Float_t         jetHFEMEnergyFraction[115];   //[nJets]
   Int_t           jetChargedHadronMultiplicity[115];   //[nJets]
   Int_t           jetNeutralHadronMultiplicity[115];   //[nJets]
   Int_t           jetPhotonMultiplicity[115];   //[nJets]
   Int_t           jetElectronMultiplicity[115];   //[nJets]
   Int_t           jetMuonMultiplicity[115];   //[nJets]
   Int_t           jetNSV[115];   //[nJets]
   Int_t           jetNSVCand[115];   //[nJets]
   Int_t           jetNVertexTracks[115];   //[nJets]
   Int_t           jetNSelectedTracks[115];   //[nJets]
   Float_t         jetDRSVJet[115];   //[nJets]
   Float_t         jetFlightDist2D[115];   //[nJets]
   Float_t         jetFlightDist2DError[115];   //[nJets]
   Float_t         jetFlightDist3D[115];   //[nJets]
   Float_t         jetFlightDist3DError[115];   //[nJets]
   Float_t         jetSV_x[115];   //[nJets]
   Float_t         jetSV_y[115];   //[nJets]
   Float_t         jetSV_z[115];   //[nJets]
   Int_t           jetSVNTracks[115];   //[nJets]
   Float_t         jetSVMass[115];   //[nJets]
   Float_t         jetAllMuonPt[115];   //[nJets]
   Float_t         jetAllMuonEta[115];   //[nJets]
   Float_t         jetAllMuonPhi[115];   //[nJets]
   Float_t         jetAllMuonM[115];   //[nJets]
   Float_t         jetPtWeightedDZ[115];   //[nJets]
   Int_t           jetNRechits[115];   //[nJets]
   Float_t         jetRechitE[115];   //[nJets]
   Float_t         jetRechitT[115];   //[nJets]
   Float_t         jetRechitT_rms[115];   //[nJets]
   Float_t         jetRechitE_Error[115];   //[nJets]
   Float_t         jetRechitT_Error[115];   //[nJets]
   Float_t         jetAlphaMax[115];   //[nJets]
   Float_t         jetBetaMax[115];   //[nJets]
   Float_t         jetGammaMax_ET[115];   //[nJets]
   Float_t         jetGammaMax_EM[115];   //[nJets]
   Float_t         jetGammaMax_Hadronic[115];   //[nJets]
   Float_t         jetGammaMax[115];   //[nJets]
   Float_t         jetPtAllTracks[115];   //[nJets]
   Float_t         jetPtAllPVTracks[115];   //[nJets]
   Float_t         jetMedianTheta2D[115];   //[nJets]
   Float_t         jetMedianIP[115];   //[nJets]
   Float_t         jetMinDeltaRAllTracks[115];   //[nJets]
   Float_t         jetMinDeltaRPVTracks[115];   //[nJets]
   Float_t         jet_sig_et1[115];   //[nJets]
   Float_t         jet_sig_et2[115];   //[nJets]
   Float_t         jet_energy_frac[115];   //[nJets]
   Float_t         jetAlphaMax_wp[115];   //[nJets]
   Float_t         jetBetaMax_wp[115];   //[nJets]
   Float_t         jetGammaMax_ET_wp[115];   //[nJets]
   Float_t         jetGammaMax_EM_wp[115];   //[nJets]
   Float_t         jetGammaMax_Hadronic_wp[115];   //[nJets]
   Float_t         jetGammaMax_wp[115];   //[nJets]
   Float_t         jetPtAllTracks_wp[115];   //[nJets]
   Float_t         jetPtAllPVTracks_wp[115];   //[nJets]
   Float_t         jetMedianTheta2D_wp[115];   //[nJets]
   Float_t         jetMedianIP_wp[115];   //[nJets]
   Float_t         jetMinDeltaRAllTracks_wp[115];   //[nJets]
   Float_t         jetMinDeltaRPVTracks_wp[115];   //[nJets]
   Int_t           jetNPFCands[115];   //[nJets]
   Int_t           jetPFCandIndex[115][5000];   //[nJets]
   UInt_t          nFatJets;
   ...
   Int_t           nGenParticle;
   Int_t           gParticleMotherId[49];   //[nGenParticle]
   Int_t           gParticleMotherIndex[49];   //[nGenParticle]
   Int_t           gParticleId[49];   //[nGenParticle]
   Int_t           gParticleStatus[49];   //[nGenParticle]
   Float_t         gParticleE[49];   //[nGenParticle]
   Float_t         gParticlePt[49];   //[nGenParticle]
   Float_t         gParticleEta[49];   //[nGenParticle]
   Float_t         gParticlePhi[49];   //[nGenParticle]
   Float_t         gParticleProdVertexX[49];   //[nGenParticle]
   Float_t         gParticleProdVertexY[49];   //[nGenParticle]
   Float_t         gParticleProdVertexZ[49];   //[nGenParticle]
   Float_t         gParticleDecayVertexX[49];   //[nGenParticle]
   Float_t         gParticleDecayVertexY[49];   //[nGenParticle]
   Float_t         gParticleDecayVertexZ[49];   //[nGenParticle]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cmsxrootd.fnal.gov//store/user/zhao1/llp/merge_dymc/merge_displacedJetMuon_ntupler_dymc.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cmsxrootd.fnal.gov//store/user/zhao1/llp/merge_dymc/merge_displacedJetMuon_ntupler_dymc.root");
      }
