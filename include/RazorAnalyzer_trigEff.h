...
#ifndef RazorAnalyzer_trigEff_h
#define RazorAnalyzer_trigEff_h

#include "llp_event_trigEff.h" //This is a MakeClass of the llp tree in the ntuple to be analyzed
...
class RazorAnalyzer_trigEff : public llp_event_trigEff
{
public:
    RazorAnalyzer_trigEff(TTree *tree = 0);
    virtual ~RazorAnalyzer_trigEff();
