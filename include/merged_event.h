...
merged_event::merged_event(TTree *tree) : fChain(0)
{
   ...
   if (tree == 0)
   {
      TFile *f = (TFile *)gROOT->GetListOfFiles()->FindObject("root://cmsxrootd.fnal.gov//store/data/Run2022C/JetMET/NANOAOD/22Sep2023-v1/40000/04bdd0bc-916b-4779-9bbd-b74e001e5423.root");
      if (!f || !f->IsOpen())
      {
