...
// Thu Aug 15 16:22:15 2024 by ROOT version 6.14/09
// from TTree Events/Events
// found on file: root://cmsxrootd.fnal.gov//store/user/amalbert/MDSTriggerEff/merge_MCSummer23_DY50to120_postBPix_hadded/MCSummer23_DY50to120_postBPix.root
//////////////////////////////////////////////////////////

#ifndef llp_event_trigEff_h
#define llp_event_trigEff_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nboostedTau;
   UChar_t         boostedTau_idAntiEle2018[500];   //[nboostedTau]
   UChar_t         boostedTau_idAntiMu[500];   //[nboostedTau]
   UChar_t         boostedTau_idMVAnewDM2017v2[500];   //[nboostedTau]
   UChar_t         boostedTau_idMVAoldDM2017v2[500];   //[nboostedTau]
   Short_t         boostedTau_jetIdx[500];   //[nboostedTau]
   Short_t         boostedTau_rawAntiEleCat2018[500];   //[nboostedTau]
   Int_t           boostedTau_charge[500];   //[nboostedTau]
   Int_t           boostedTau_decayMode[500];   //[nboostedTau]
   Float_t         boostedTau_chargedIso[500];   //[nboostedTau]
   Float_t         boostedTau_eta[500];   //[nboostedTau]
   Float_t         boostedTau_leadTkDeltaEta[500];   //[nboostedTau]
   Float_t         boostedTau_leadTkDeltaPhi[500];   //[nboostedTau]
   Float_t         boostedTau_leadTkPtOverTauPt[500];   //[nboostedTau]
   Float_t         boostedTau_mass[500];   //[nboostedTau]
   Float_t         boostedTau_neutralIso[500];   //[nboostedTau]
   Float_t         boostedTau_phi[500];   //[nboostedTau]
   Float_t         boostedTau_photonsOutsideSignalCone[500];   //[nboostedTau]
   Float_t         boostedTau_pt[500];   //[nboostedTau]
   Float_t         boostedTau_puCorr[500];   //[nboostedTau]
   Float_t         boostedTau_rawAntiEle2018[500];   //[nboostedTau]
   Float_t         boostedTau_rawIso[500];   //[nboostedTau]
   Float_t         boostedTau_rawIsodR03[500];   //[nboostedTau]
   Float_t         boostedTau_rawMVAnewDM2017v2[500];   //[nboostedTau]
   Float_t         boostedTau_rawMVAoldDM2017v2[500];   //[nboostedTau]
   Float_t         CaloMET_phi;
   Float_t         CaloMET_pt;
   ...
   Int_t           nCorrT1METJet;
   Float_t         CorrT1METJet_area[500];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_eta[500];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_muonSubtrFactor[500];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_phi[500];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_rawPt[500];   //[nCorrT1METJet]
   ...
   Int_t           nElectron;
   Char_t          Electron_seediEtaOriX[500];   //[nElectron]
   Bool_t          Electron_convVeto[500];   //[nElectron]
   UChar_t         Electron_cutBased[500];   //[nElectron]
   Bool_t          Electron_cutBased_HEEP[500];   //[nElectron]
   Bool_t          Electron_isPFcand[500];   //[nElectron]
   UChar_t         Electron_jetNDauCharged[500];   //[nElectron]
   UChar_t         Electron_lostHits[500];   //[nElectron]
   Bool_t          Electron_mvaIso_WP80[500];   //[nElectron]
   Bool_t          Electron_mvaIso_WP90[500];   //[nElectron]
   Bool_t          Electron_mvaNoIso_WP80[500];   //[nElectron]
   Bool_t          Electron_mvaNoIso_WP90[500];   //[nElectron]
   UChar_t         Electron_seedGain[500];   //[nElectron]
   UChar_t         Electron_tightCharge[500];   //[nElectron]
   Short_t         Electron_jetIdx[500];   //[nElectron]
   Short_t         Electron_photonIdx[500];   //[nElectron]
   Short_t         Electron_svIdx[500];   //[nElectron]
   Short_t         Electron_fsrPhotonIdx[500];   //[nElectron]
   Int_t           Electron_charge[500];   //[nElectron]
   Int_t           Electron_pdgId[500];   //[nElectron]
   Int_t           Electron_seediPhiOriY[500];   //[nElectron]
   Int_t           Electron_vidNestedWPBitmap[500];   //[nElectron]
   Int_t           Electron_vidNestedWPBitmapHEEP[500];   //[nElectron]
   Float_t         Electron_deltaEtaSC[500];   //[nElectron]
   Float_t         Electron_dr03EcalRecHitSumEt[500];   //[nElectron]
   Float_t         Electron_dr03HcalDepth1TowerSumEt[500];   //[nElectron]
   Float_t         Electron_dr03TkSumPt[500];   //[nElectron]
   Float_t         Electron_dr03TkSumPtHEEP[500];   //[nElectron]
   ...
   Float_t         Electron_eInvMinusPInv[500];   //[nElectron]
   Float_t         Electron_energyErr[500];   //[nElectron]
   Float_t         Electron_eta[500];   //[nElectron]
   Float_t         Electron_hoe[500];   //[nElectron]
   Float_t         Electron_ip3d[500];   //[nElectron]
   Float_t         Electron_jetPtRelv2[500];   //[nElectron]
   Float_t         Electron_jetRelIso[500];   //[nElectron]
   Float_t         Electron_mass[500];   //[nElectron]
   Float_t         Electron_miniPFRelIso_all[500];   //[nElectron]
   Float_t         Electron_miniPFRelIso_chg[500];   //[nElectron]
   Float_t         Electron_mvaHZZIso[500];   //[nElectron]
   Float_t         Electron_mvaIso[500];   //[nElectron]
   Float_t         Electron_mvaNoIso[500];   //[nElectron]
   Float_t         Electron_pfRelIso03_all[500];   //[nElectron]
   Float_t         Electron_pfRelIso03_chg[500];   //[nElectron]
   Float_t         Electron_phi[500];   //[nElectron]
   Float_t         Electron_pt[500];   //[nElectron]
   Float_t         Electron_r9[500];   //[nElectron]
   Float_t         Electron_scEtOverPt[500];   //[nElectron]
   Float_t         Electron_sieie[500];   //[nElectron]
   Float_t         Electron_sip3d[500];   //[nElectron]
   Float_t         Electron_mvaTTH[500];   //[nElectron]
   Int_t           nFatJet;
   UChar_t         FatJet_jetId[500];   //[nFatJet]
   UChar_t         FatJet_nConstituents[500];   //[nFatJet]
   Short_t         FatJet_subJetIdx1[500];   //[nFatJet]
   Short_t         FatJet_subJetIdx2[500];   //[nFatJet]
   Short_t         FatJet_electronIdx3SJ[500];   //[nFatJet]
   Short_t         FatJet_muonIdx3SJ[500];   //[nFatJet]
   Float_t         FatJet_area[500];   //[nFatJet]
   Float_t         FatJet_btagDDBvLV2[500];   //[nFatJet]
   Float_t         FatJet_btagDDCvBV2[500];   //[nFatJet]
   Float_t         FatJet_btagDDCvLV2[500];   //[nFatJet]
   Float_t         FatJet_btagDeepB[500];   //[nFatJet]
   Float_t         FatJet_btagHbb[500];   //[nFatJet]
   Float_t         FatJet_eta[500];   //[nFatJet]
   Float_t         FatJet_mass[500];   //[nFatJet]
   Float_t         FatJet_msoftdrop[500];   //[nFatJet]
   Float_t         FatJet_n2b1[500];   //[nFatJet]
   Float_t         FatJet_n3b1[500];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_H4qvsQCD[500];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_HbbvsQCD[500];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_HccvsQCD[500];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_QCD[500];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_TvsQCD[500];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_WvsQCD[500];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_ZvsQCD[500];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD[500];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD0HF[500];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD1HF[500];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD2HF[500];   //[nFatJet]
   Float_t         FatJet_particleNet_XbbVsQCD[500];   //[nFatJet]
   Float_t         FatJet_particleNet_XccVsQCD[500];   //[nFatJet]
   Float_t         FatJet_particleNet_XggVsQCD[500];   //[nFatJet]
   Float_t         FatJet_particleNet_XqqVsQCD[500];   //[nFatJet]
   Float_t         FatJet_particleNet_XteVsQCD[500];   //[nFatJet]
   Float_t         FatJet_particleNet_XtmVsQCD[500];   //[nFatJet]
   Float_t         FatJet_particleNet_XttVsQCD[500];   //[nFatJet]
   Float_t         FatJet_particleNet_massCorr[500];   //[nFatJet]
   Float_t         FatJet_phi[500];   //[nFatJet]
   Float_t         FatJet_pt[500];   //[nFatJet]
   Float_t         FatJet_rawFactor[500];   //[nFatJet]
   Float_t         FatJet_tau1[500];   //[nFatJet]
   Float_t         FatJet_tau2[500];   //[nFatJet]
   Float_t         FatJet_tau3[500];   //[nFatJet]
   Float_t         FatJet_tau4[500];   //[nFatJet]
   Float_t         FatJet_lsf3[500];   //[nFatJet]
   Int_t           nFsrPhoton;
   Short_t         FsrPhoton_electronIdx[500];   //[nFsrPhoton]
   Short_t         FsrPhoton_muonIdx[500];   //[nFsrPhoton]
   Float_t         FsrPhoton_dROverEt2[500];   //[nFsrPhoton]
   Float_t         FsrPhoton_eta[500];   //[nFsrPhoton]
   Float_t         FsrPhoton_phi[500];   //[nFsrPhoton]
   Float_t         FsrPhoton_pt[500];   //[nFsrPhoton]
   Float_t         FsrPhoton_relIso03[500];   //[nFsrPhoton]
   Int_t           nGenJetAK8;
   Float_t         GenJetAK8_eta[500];   //[nGenJetAK8]
   Float_t         GenJetAK8_mass[500];   //[nGenJetAK8]
   Float_t         GenJetAK8_phi[500];   //[nGenJetAK8]
   Float_t         GenJetAK8_pt[500];   //[nGenJetAK8]
   Int_t           nGenJet;
   Float_t         GenJet_eta[500];   //[nGenJet]
   Float_t         GenJet_mass[500];   //[nGenJet]
   Float_t         GenJet_phi[500];   //[nGenJet]
   Float_t         GenJet_pt[500];   //[nGenJet]
   Int_t           nGenPart;
   ...
   Int_t           nGenProton;
   Bool_t          GenProton_isPU[500];   //[nGenProton]
   Float_t         GenProton_px[500];   //[nGenProton]
   Float_t         GenProton_py[500];   //[nGenProton]
   Float_t         GenProton_pz[500];   //[nGenProton]
   Float_t         GenProton_vz[500];   //[nGenProton]
   Int_t           nSubGenJetAK8;
   Float_t         SubGenJetAK8_eta[500];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_mass[500];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_phi[500];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_pt[500];   //[nSubGenJetAK8]
   Int_t           Generator_id1;
   Int_t           Generator_id2;
   ...
   Float_t         GenVtx_z;
   Int_t           nGenVisTau;
   UChar_t         GenVisTau_status[500];   //[nGenVisTau]
   Short_t         GenVisTau_charge[500];   //[nGenVisTau]
   Short_t         GenVisTau_genPartIdxMother[500];   //[nGenVisTau]
   Float_t         GenVisTau_eta[500];   //[nGenVisTau]
   Float_t         GenVisTau_mass[500];   //[nGenVisTau]
   Float_t         GenVisTau_phi[500];   //[nGenVisTau]
   Float_t         GenVisTau_pt[500];   //[nGenVisTau]
   Float_t         genWeight;
   Float_t         LHEWeight_originalXWGTUP;
   Int_t           nLHEPdfWeight;
   Float_t         LHEPdfWeight[500];   //[nLHEPdfWeight]
   Int_t           nLHEReweightingWeight;
   Float_t         LHEReweightingWeight[500];   //[nLHEReweightingWeight]
   Int_t           nLHEScaleWeight;
   Float_t         LHEScaleWeight[500];   //[nLHEScaleWeight]
   Int_t           nPSWeight;
   Float_t         PSWeight[500];   //[nPSWeight]
   Int_t           nIsoTrack;
   Bool_t          IsoTrack_isHighPurityTrack[500];   //[nIsoTrack]
   Bool_t          IsoTrack_isPFcand[500];   //[nIsoTrack]
   Bool_t          IsoTrack_isFromLostTrack[500];   //[nIsoTrack]
   Short_t         IsoTrack_charge[500];   //[nIsoTrack]
   Short_t         IsoTrack_fromPV[500];   //[nIsoTrack]
   Int_t           IsoTrack_pdgId[500];   //[nIsoTrack]
   Float_t         IsoTrack_dxy[500];   //[nIsoTrack]
   Float_t         IsoTrack_dz[500];   //[nIsoTrack]
   Float_t         IsoTrack_eta[500];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_all[500];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_chg[500];   //[nIsoTrack]
   Float_t         IsoTrack_phi[500];   //[nIsoTrack]
   Float_t         IsoTrack_pt[500];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_all[500];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_chg[500];   //[nIsoTrack]
   Int_t           nJet;
   UChar_t         Jet_jetId[500];   //[nJet]
   UChar_t         Jet_nConstituents[500];   //[nJet]
   UChar_t         Jet_nElectrons[500];   //[nJet]
   UChar_t         Jet_nMuons[500];   //[nJet]
   UChar_t         Jet_nSVs[500];   //[nJet]
   Short_t         Jet_electronIdx1[500];   //[nJet]
   Short_t         Jet_electronIdx2[500];   //[nJet]
   Short_t         Jet_muonIdx1[500];   //[nJet]
   Short_t         Jet_muonIdx2[500];   //[nJet]
   Short_t         Jet_svIdx1[500];   //[nJet]
   Short_t         Jet_svIdx2[500];   //[nJet]
   Int_t           Jet_hfadjacentEtaStripsSize[500];   //[nJet]
   Int_t           Jet_hfcentralEtaStripSize[500];   //[nJet]
   Float_t         Jet_PNetRegPtRawCorr[500];   //[nJet]
   Float_t         Jet_PNetRegPtRawCorrNeutrino[500];   //[nJet]
   Float_t         Jet_PNetRegPtRawRes[500];   //[nJet]
   Float_t         Jet_area[500];   //[nJet]
   Float_t         Jet_btagDeepFlavB[500];   //[nJet]
   Float_t         Jet_btagDeepFlavCvB[500];   //[nJet]
   Float_t         Jet_btagDeepFlavCvL[500];   //[nJet]
   Float_t         Jet_btagDeepFlavQG[500];   //[nJet]
   Float_t         Jet_btagPNetB[500];   //[nJet]
   Float_t         Jet_btagPNetCvB[500];   //[nJet]
   Float_t         Jet_btagPNetCvL[500];   //[nJet]
   Float_t         Jet_btagPNetQvG[500];   //[nJet]
   Float_t         Jet_btagPNetTauVJet[500];   //[nJet]
   Float_t         Jet_btagRobustParTAK4B[500];   //[nJet]
   Float_t         Jet_btagRobustParTAK4CvB[500];   //[nJet]
   Float_t         Jet_btagRobustParTAK4CvL[500];   //[nJet]
   Float_t         Jet_btagRobustParTAK4QG[500];   //[nJet]
   Float_t         Jet_chEmEF[500];   //[nJet]
   Float_t         Jet_chHEF[500];   //[nJet]
   Float_t         Jet_eta[500];   //[nJet]
   Float_t         Jet_hfsigmaEtaEta[500];   //[nJet]
   Float_t         Jet_hfsigmaPhiPhi[500];   //[nJet]
   Float_t         Jet_mass[500];   //[nJet]
   Float_t         Jet_muEF[500];   //[nJet]
   Float_t         Jet_muonSubtrFactor[500];   //[nJet]
   Float_t         Jet_neEmEF[500];   //[nJet]
   Float_t         Jet_neHEF[500];   //[nJet]
   Float_t         Jet_phi[500];   //[nJet]
   Float_t         Jet_pt[500];   //[nJet]
   Float_t         Jet_rawFactor[500];   //[nJet]
   UChar_t         LHE_Njets;
   UChar_t         LHE_Nb;
   UChar_t         LHE_Nc;
   UChar_t         LHE_Nuds;
   ...
   Float_t         LHE_AlphaS;
   Int_t           nLHEPart;
   Int_t           LHEPart_pdgId[500];   //[nLHEPart]
   Int_t           LHEPart_status[500];   //[nLHEPart]
   Int_t           LHEPart_spin[500];   //[nLHEPart]
   Float_t         LHEPart_pt[500];   //[nLHEPart]
   Float_t         LHEPart_eta[500];   //[nLHEPart]
   Float_t         LHEPart_phi[500];   //[nLHEPart]
   Float_t         LHEPart_mass[500];   //[nLHEPart]
   Float_t         LHEPart_incomingpz[500];   //[nLHEPart]
   Int_t           nLowPtElectron;
   Bool_t          LowPtElectron_convVeto[500];   //[nLowPtElectron]
   UChar_t         LowPtElectron_convWP[500];   //[nLowPtElectron]
   UChar_t         LowPtElectron_lostHits[500];   //[nLowPtElectron]
   Short_t         LowPtElectron_electronIdx[500];   //[nLowPtElectron]
   Short_t         LowPtElectron_photonIdx[500];   //[nLowPtElectron]
   Int_t           LowPtElectron_charge[500];   //[nLowPtElectron]
   Int_t           LowPtElectron_pdgId[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_ID[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_convVtxRadius[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_deltaEtaSC[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_dxy[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_dxyErr[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_dz[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_dzErr[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_eInvMinusPInv[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_energyErr[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_eta[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_hoe[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_mass[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_miniPFRelIso_all[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_miniPFRelIso_chg[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_phi[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_pt[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_ptbiased[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_r9[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_scEtOverPt[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_sieie[500];   //[nLowPtElectron]
   Float_t         LowPtElectron_unbiased[500];   //[nLowPtElectron]
   Float_t         GenMET_phi;
   Float_t         GenMET_pt;
   ...
   Int_t           nMuon;
   UChar_t         Muon_highPtId[500];   //[nMuon]
   Bool_t          Muon_highPurity[500];   //[nMuon]
   Bool_t          Muon_inTimeMuon[500];   //[nMuon]
   Bool_t          Muon_isGlobal[500];   //[nMuon]
   Bool_t          Muon_isPFcand[500];   //[nMuon]
   Bool_t          Muon_isStandalone[500];   //[nMuon]
   Bool_t          Muon_isTracker[500];   //[nMuon]
   UChar_t         Muon_jetNDauCharged[500];   //[nMuon]
   Bool_t          Muon_looseId[500];   //[nMuon]
   Bool_t          Muon_mediumId[500];   //[nMuon]
   Bool_t          Muon_mediumPromptId[500];   //[nMuon]
   UChar_t         Muon_miniIsoId[500];   //[nMuon]
   UChar_t         Muon_multiIsoId[500];   //[nMuon]
   UChar_t         Muon_mvaMuID_WP[500];   //[nMuon]
   UChar_t         Muon_nStations[500];   //[nMuon]
   UChar_t         Muon_nTrackerLayers[500];   //[nMuon]
   UChar_t         Muon_pfIsoId[500];   //[nMuon]
   UChar_t         Muon_puppiIsoId[500];   //[nMuon]
   Bool_t          Muon_softId[500];   //[nMuon]
   Bool_t          Muon_softMvaId[500];   //[nMuon]
   UChar_t         Muon_tightCharge[500];   //[nMuon]
   Bool_t          Muon_tightId[500];   //[nMuon]
   UChar_t         Muon_tkIsoId[500];   //[nMuon]
   Bool_t          Muon_triggerIdLoose[500];   //[nMuon]
   Short_t         Muon_jetIdx[500];   //[nMuon]
   Short_t         Muon_svIdx[500];   //[nMuon]
   Short_t         Muon_fsrPhotonIdx[500];   //[nMuon]
   Int_t           Muon_charge[500];   //[nMuon]
   Int_t           Muon_pdgId[500];   //[nMuon]
   Float_t         Muon_dxy[500];   //[nMuon]
   Float_t         Muon_dxyErr[500];   //[nMuon]
   Float_t         Muon_dxybs[500];   //[nMuon]
   Float_t         Muon_dz[500];   //[nMuon]
   Float_t         Muon_dzErr[500];   //[nMuon]
   Float_t         Muon_eta[500];   //[nMuon]
   Float_t         Muon_ip3d[500];   //[nMuon]
   Float_t         Muon_jetPtRelv2[500];   //[nMuon]
   Float_t         Muon_jetRelIso[500];   //[nMuon]
   Float_t         Muon_mass[500];   //[nMuon]
   Float_t         Muon_miniPFRelIso_all[500];   //[nMuon]
   Float_t         Muon_miniPFRelIso_chg[500];   //[nMuon]
   Float_t         Muon_mvaMuID[500];   //[nMuon]
   Float_t         Muon_pfRelIso03_all[500];   //[nMuon]
   Float_t         Muon_pfRelIso03_chg[500];   //[nMuon]
   Float_t         Muon_pfRelIso04_all[500];   //[nMuon]
   Float_t         Muon_phi[500];   //[nMuon]
   Float_t         Muon_pt[500];   //[nMuon]
   Float_t         Muon_ptErr[500];   //[nMuon]
   Float_t         Muon_segmentComp[500];   //[nMuon]
   Float_t         Muon_sip3d[500];   //[nMuon]
   Float_t         Muon_softMva[500];   //[nMuon]
   Float_t         Muon_tkRelIso[500];   //[nMuon]
   Float_t         Muon_tunepRelPt[500];   //[nMuon]
   Float_t         Muon_bsConstrainedChi2[500];   //[nMuon]
   Float_t         Muon_bsConstrainedPt[500];   //[nMuon]
   Float_t         Muon_bsConstrainedPtErr[500];   //[nMuon]
   Float_t         Muon_mvaLowPt[500];   //[nMuon]
   Float_t         Muon_mvaTTH[500];   //[nMuon]
   Int_t           nPhoton;
   Char_t          Photon_seediEtaOriX[500];   //[nPhoton]
   UChar_t         Photon_cutBased[500];   //[nPhoton]
   Bool_t          Photon_electronVeto[500];   //[nPhoton]
   Bool_t          Photon_hasConversionTracks[500];   //[nPhoton]
   Bool_t          Photon_isScEtaEB[500];   //[nPhoton]
   Bool_t          Photon_isScEtaEE[500];   //[nPhoton]
   Bool_t          Photon_mvaID_WP80[500];   //[nPhoton]
   Bool_t          Photon_mvaID_WP90[500];   //[nPhoton]
   Bool_t          Photon_pixelSeed[500];   //[nPhoton]
   UChar_t         Photon_seedGain[500];   //[nPhoton]
   Short_t         Photon_electronIdx[500];   //[nPhoton]
   Short_t         Photon_jetIdx[500];   //[nPhoton]
   Int_t           Photon_seediPhiOriY[500];   //[nPhoton]
   Int_t           Photon_vidNestedWPBitmap[500];   //[nPhoton]
   Float_t         Photon_ecalPFClusterIso[500];   //[nPhoton]
   Float_t         Photon_energyErr[500];   //[nPhoton]
   Float_t         Photon_energyRaw[500];   //[nPhoton]
   Float_t         Photon_esEffSigmaRR[500];   //[nPhoton]
   Float_t         Photon_esEnergyOverRawE[500];   //[nPhoton]
   Float_t         Photon_eta[500];   //[nPhoton]
   Float_t         Photon_etaWidth[500];   //[nPhoton]
   Float_t         Photon_haloTaggerMVAVal[500];   //[nPhoton]
   Float_t         Photon_hcalPFClusterIso[500];   //[nPhoton]
   Float_t         Photon_hoe[500];   //[nPhoton]
   Float_t         Photon_hoe_PUcorr[500];   //[nPhoton]
   Float_t         Photon_mvaID[500];   //[nPhoton]
   Float_t         Photon_pfChargedIso[500];   //[nPhoton]
   Float_t         Photon_pfChargedIsoPFPV[500];   //[nPhoton]
   Float_t         Photon_pfChargedIsoWorstVtx[500];   //[nPhoton]
   Float_t         Photon_pfPhoIso03[500];   //[nPhoton]
   Float_t         Photon_pfRelIso03_all_quadratic[500];   //[nPhoton]
   Float_t         Photon_pfRelIso03_chg_quadratic[500];   //[nPhoton]
   Float_t         Photon_phi[500];   //[nPhoton]
   Float_t         Photon_phiWidth[500];   //[nPhoton]
   Float_t         Photon_pt[500];   //[nPhoton]
   Float_t         Photon_r9[500];   //[nPhoton]
   Float_t         Photon_s4[500];   //[nPhoton]
   Float_t         Photon_sieie[500];   //[nPhoton]
   Float_t         Photon_sieip[500];   //[nPhoton]
   Float_t         Photon_sipip[500];   //[nPhoton]
   Float_t         Photon_trkSumPtHollowConeDR03[500];   //[nPhoton]
   Float_t         Photon_trkSumPtSolidConeDR04[500];   //[nPhoton]
   Float_t         Photon_x_calo[500];   //[nPhoton]
   Float_t         Photon_y_calo[500];   //[nPhoton]
   Float_t         Photon_z_calo[500];   //[nPhoton]
   Int_t           Pileup_nPU;
   ...
   Bool_t          GenDressedLepton_hasTauAnc[500];   //[nGenDressedLepton]
   Int_t           GenDressedLepton_pdgId[500];   //[nGenDressedLepton]
   Float_t         GenDressedLepton_eta[500];   //[nGenDressedLepton]
   Float_t         GenDressedLepton_mass[500];   //[nGenDressedLepton]
   Float_t         GenDressedLepton_phi[500];   //[nGenDressedLepton]
   Float_t         GenDressedLepton_pt[500];   //[nGenDressedLepton]
   ...
   Float_t         SoftActivityJet_eta[500];   //[nSoftActivityJet]
   Float_t         SoftActivityJet_phi[500];   //[nSoftActivityJet]
   Float_t         SoftActivityJet_pt[500];   //[nSoftActivityJet]
   ...
   Int_t           nSubJet;
   Float_t         SubJet_btagDeepB[500];   //[nSubJet]
   Float_t         SubJet_eta[500];   //[nSubJet]
   Float_t         SubJet_mass[500];   //[nSubJet]
   Float_t         SubJet_n2b1[500];   //[nSubJet]
   Float_t         SubJet_n3b1[500];   //[nSubJet]
   Float_t         SubJet_phi[500];   //[nSubJet]
   Float_t         SubJet_pt[500];   //[nSubJet]
   Float_t         SubJet_rawFactor[500];   //[nSubJet]
   Float_t         SubJet_tau1[500];   //[nSubJet]
   Float_t         SubJet_tau2[500];   //[nSubJet]
   Float_t         SubJet_tau3[500];   //[nSubJet]
   Float_t         SubJet_tau4[500];   //[nSubJet]
   Int_t           nTau;
   UChar_t         Tau_decayMode[500];   //[nTau]
   Bool_t          Tau_idAntiEleDeadECal[500];   //[nTau]
   UChar_t         Tau_idAntiMu[500];   //[nTau]
   Bool_t          Tau_idDecayModeNewDMs[500];   //[nTau]
   Bool_t          Tau_idDecayModeOldDMs[500];   //[nTau]
   UChar_t         Tau_idDeepTau2017v2p1VSe[500];   //[nTau]
   UChar_t         Tau_idDeepTau2017v2p1VSjet[500];   //[nTau]
   UChar_t         Tau_idDeepTau2017v2p1VSmu[500];   //[nTau]
   UChar_t         Tau_idDeepTau2018v2p5VSe[500];   //[nTau]
   UChar_t         Tau_idDeepTau2018v2p5VSjet[500];   //[nTau]
   UChar_t         Tau_idDeepTau2018v2p5VSmu[500];   //[nTau]
   UChar_t         Tau_nSVs[500];   //[nTau]
   Short_t         Tau_charge[500];   //[nTau]
   Short_t         Tau_decayModePNet[500];   //[nTau]
   Short_t         Tau_eleIdx[500];   //[nTau]
   Short_t         Tau_jetIdx[500];   //[nTau]
   Short_t         Tau_muIdx[500];   //[nTau]
   Short_t         Tau_svIdx1[500];   //[nTau]
   Short_t         Tau_svIdx2[500];   //[nTau]
   Float_t         Tau_chargedIso[500];   //[nTau]
   Float_t         Tau_dxy[500];   //[nTau]
   Float_t         Tau_dz[500];   //[nTau]
   Float_t         Tau_eta[500];   //[nTau]
   Float_t         Tau_leadTkDeltaEta[500];   //[nTau]
   Float_t         Tau_leadTkDeltaPhi[500];   //[nTau]
   Float_t         Tau_leadTkPtOverTauPt[500];   //[nTau]
   Float_t         Tau_mass[500];   //[nTau]
   Float_t         Tau_neutralIso[500];   //[nTau]
   Float_t         Tau_phi[500];   //[nTau]
   Float_t         Tau_photonsOutsideSignalCone[500];   //[nTau]
   Float_t         Tau_probDM0PNet[500];   //[nTau]
   Float_t         Tau_probDM10PNet[500];   //[nTau]
   Float_t         Tau_probDM11PNet[500];   //[nTau]
   Float_t         Tau_probDM1PNet[500];   //[nTau]
   Float_t         Tau_probDM2PNet[500];   //[nTau]
   Float_t         Tau_pt[500];   //[nTau]
   Float_t         Tau_ptCorrPNet[500];   //[nTau]
   Float_t         Tau_puCorr[500];   //[nTau]
   Float_t         Tau_qConfPNet[500];   //[nTau]
   Float_t         Tau_rawDeepTau2017v2p1VSe[500];   //[nTau]
   Float_t         Tau_rawDeepTau2017v2p1VSjet[500];   //[nTau]
   Float_t         Tau_rawDeepTau2017v2p1VSmu[500];   //[nTau]
   Float_t         Tau_rawDeepTau2018v2p5VSe[500];   //[nTau]
   Float_t         Tau_rawDeepTau2018v2p5VSjet[500];   //[nTau]
   Float_t         Tau_rawDeepTau2018v2p5VSmu[500];   //[nTau]
   Float_t         Tau_rawIso[500];   //[nTau]
   Float_t         Tau_rawIsodR03[500];   //[nTau]
   Float_t         Tau_rawPNetVSe[500];   //[nTau]
   Float_t         Tau_rawPNetVSjet[500];   //[nTau]
   Float_t         Tau_rawPNetVSmu[500];   //[nTau]
   Float_t         TkMET_phi;
   Float_t         TkMET_pt;
   Float_t         TkMET_sumEt;
   Int_t           nTrigObj;
   Short_t         TrigObj_l1charge[64];   //[nTrigObj]
   UShort_t        TrigObj_id[64];   //[nTrigObj]
   Int_t           TrigObj_l1iso[64];   //[nTrigObj]
   Int_t           TrigObj_filterBits[64];   //[nTrigObj]
   Float_t         TrigObj_pt[64];   //[nTrigObj]
   Float_t         TrigObj_eta[64];   //[nTrigObj]
   Float_t         TrigObj_phi[64];   //[nTrigObj]
   Float_t         TrigObj_l1pt[64];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[64];   //[nTrigObj]
   Float_t         TrigObj_l2pt[64];   //[nTrigObj]
   Int_t           genTtbarId;
   Int_t           nOtherPV;
   Float_t         OtherPV_z[500];   //[nOtherPV]
   Float_t         OtherPV_score[500];   //[nOtherPV]
   UChar_t         PV_npvs;
   UChar_t         PV_npvsGood;
   Float_t         PV_ndof;
   Float_t         PV_x;
   ...
   Float_t         PV_score;
   Int_t           nSV;
   Short_t         SV_charge[500];   //[nSV]
   Float_t         SV_dlen[500];   //[nSV]
   Float_t         SV_dlenSig[500];   //[nSV]
   Float_t         SV_dxy[500];   //[nSV]
   Float_t         SV_dxySig[500];   //[nSV]
   Float_t         SV_pAngle[500];   //[nSV]
   UChar_t         boostedTau_genPartFlav[500];   //[nboostedTau]
   Short_t         boostedTau_genPartIdx[500];   //[nboostedTau]
   UChar_t         Electron_genPartFlav[500];   //[nElectron]
   Short_t         Electron_genPartIdx[500];   //[nElectron]
   UChar_t         FatJet_hadronFlavour[500];   //[nFatJet]
   UChar_t         FatJet_nBHadrons[500];   //[nFatJet]
   UChar_t         FatJet_nCHadrons[500];   //[nFatJet]
   Short_t         FatJet_genJetAK8Idx[500];   //[nFatJet]
   UChar_t         GenJetAK8_hadronFlavour[500];   //[nGenJetAK8]
   Short_t         GenJetAK8_partonFlavour[500];   //[nGenJetAK8]
   UChar_t         GenJet_hadronFlavour[500];   //[nGenJet]
   Short_t         GenJet_partonFlavour[500];   //[nGenJet]
   Float_t         GenVtx_t0;
   UChar_t         Jet_hadronFlavour[500];   //[nJet]
   Short_t         Jet_genJetIdx[500];   //[nJet]
   Short_t         Jet_partonFlavour[500];   //[nJet]
   UChar_t         LowPtElectron_genPartFlav[500];   //[nLowPtElectron]
   Short_t         LowPtElectron_genPartIdx[500];   //[nLowPtElectron]
   UChar_t         Muon_genPartFlav[500];   //[nMuon]
   Short_t         Muon_genPartIdx[500];   //[nMuon]
   UChar_t         Photon_genPartFlav[500];   //[nPhoton]
   Short_t         Photon_genPartIdx[500];   //[nPhoton]
   Float_t         MET_fiducialGenPhi;
   Float_t         MET_fiducialGenPt;
   UChar_t         SubJet_hadronFlavour[500];   //[nSubJet]
   UChar_t         SubJet_nBHadrons[500];   //[nSubJet]
   UChar_t         SubJet_nCHadrons[500];   //[nSubJet]
   UChar_t         SV_ntracks[500];   //[nSV]
   Float_t         SV_chi2[500];   //[nSV]
   Float_t         SV_eta[500];   //[nSV]
   Float_t         SV_mass[500];   //[nSV]
   Float_t         SV_ndof[500];   //[nSV]
   Float_t         SV_phi[500];   //[nSV]
   Float_t         SV_pt[500];   //[nSV]
   Float_t         SV_x[500];   //[nSV]
   Float_t         SV_y[500];   //[nSV]
   Float_t         SV_z[500];   //[nSV]
   UChar_t         Tau_genPartFlav[500];   //[nTau]
   Short_t         Tau_genPartIdx[500];   //[nTau]
   ...
   Float_t         cscSegPhi[3000];   //[nCscSeg]
   Float_t         cscSegEta[3000];   //[nCscSeg]
   Float_t         dtSegPhi[3000];   //[nDtSeg]
   Float_t         dtSegEta[3000];   //[nDtSeg]
   Float_t         rpcPhi[20000];   //[nRpc]
   Float_t         rpcEta[20000];   //[nRpc]
   Float_t         rpcX[20000];   //[nRpc]
   Float_t         rpcY[20000];   //[nRpc]
   Float_t         rpcZ[20000];   //[nRpc]
   Float_t         rpcT[20000];   //[nRpc]
   Float_t         rpcTError[20000];   //[nRpc]
   ...
   Int_t           dtRechitStation[200000];   //[nDtRechits]
   Int_t           dtRechitWheel[20000];   //[nDtRechits]
   Int_t           dtRechitSuperLayer[20000];   //[nDtRechits]
   Int_t           cscSegChamber[20000];   //[nCscSeg]
   Int_t           cscSegStation[20000];   //[nCscSeg]
   Int_t           cscSegNRecHits[20000];   //[nCscSeg]
   Int_t           dtSegStation[20000];   //[nDtSeg]
   Int_t           dtSegWheel[20000];   //[nDtSeg]
   Int_t           rpcBx[20000];   //[nRpc]
   Int_t           rpcRegion[20000];   //[nRpc]
   Int_t           rpcRing[200000];   //[nRpc]
   Int_t           rpcSector[200000];   //[nRpc]
   Int_t           rpcStation[20000];   //[nRpc]
   Int_t           rpcLayer[20000];   //[nRpc]
   ...
   llp_event_trigEff(TTree *tree=0);
   virtual ~llp_event_trigEff();
...
#ifdef llp_event_trigEff_cxx
llp_event_trigEff::llp_event_trigEff(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cmsxrootd.fnal.gov//store/user/amalbert/MDSTriggerEff/merge_MCSummer23_DY50to120_postBPix_hadded/MCSummer23_DY50to120_postBPix.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cmsxrootd.fnal.gov//store/user/amalbert/MDSTriggerEff/merge_MCSummer23_DY50to120_postBPix_hadded/MCSummer23_DY50to120_postBPix.root");
      }
...
llp_event_trigEff::~llp_event_trigEff()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t llp_event_trigEff::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t llp_event_trigEff::LoadTree(Long64_t entry)
{
...
void llp_event_trigEff::Init(TTree *tree)
{
...
Bool_t llp_event_trigEff::Notify()
{
...
void llp_event_trigEff::Show(Long64_t entry)
{
...
Int_t llp_event_trigEff::Cut(Long64_t entry)
{
...
#endif // #ifdef llp_event_trigEff_cxx
