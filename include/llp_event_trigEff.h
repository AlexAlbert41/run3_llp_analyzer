...
// Sat Apr 27 18:06:07 2024 by ROOT version 6.14/09
// from TTree llp/selected AOD information for llp analyses
// found on file: /eos/uscms/store/user/amalbert/MDSTriggerEff/combined_skimmed_merged_v4_2022/Run2022E.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms/store/user/amalbert/MDSTriggerEff/combined_skimmed_merged_v4_2022/Run2022E.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/uscms/store/user/amalbert/MDSTriggerEff/combined_skimmed_merged_v4_2022/Run2022E.root");
      }
